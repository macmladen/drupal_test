...
$aliases['stage'] = array(
    'uri' => 'http://stage.drupal_test.com',
    'root' => '/srv/www/drupal_test/stage',
    'remote-host' => 'ftp.server.com',
    'remote-user' => 'mdjuric',
    'os' => 'Linux',
    'path-aliases' => array(
      '%drush' => '/srv/www/bin',
      '%drush-script' => '/srv/www/bin/drush8',
      '%files' => 'sites/default/files',
      '%custom' => '/srv/www',
     ),
     'variables' => array(
        'site_name' => 'Drupal Test Stage',
      ),
     'command-specific' => array (
       'sql-dump' => array (
         'result-file' => 'drupal_test_stage_@DATE.sql',
       ),
//       'sql-sync' => array (
//         'no-dump' => TRUE,
//       ),
...
$aliases['prod'] = array(
  'uri' => 'http://drupal_test.com',
  'root' => '/srv/www/drupal_test/docroot',
  'remote-host' => 'ftp.server.com',
  'remote-user' => 'mdjuric',
  'os' => 'Linux',
  'path-aliases' => array(
  ...
  'variables' => array(
    'site_name' => 'Druapl Test',
  ),
  'command-specific' => array (
     'sql-dump' => array (
       'result-file' => 'drupal_test_prod_@DATE.sql',
     ),
//    'sql-sync' => array (
//      'no-dump' => TRUE,
//    ),
